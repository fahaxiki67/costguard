        ...
        steps=[{
            ...
            "path_scopes": {
                "path_a": {
                    ...
                    "selection_rule": "按期次排除小计/合计行后累计清洗明细",
                    "filters": ["period_id=当前期次", "flags_json.subtotal != true"],
                    "sheets": [{
                ...
                "path_b": {
                    ...
                    "selection_rule": "按确认数据区直接扫描原始网格",
                    "filters": ["data_range=2:3", "排除小计/合计行"],
                    "sheets": [{
                        "file_id": source_file_id,
                        "file_name": "source.xlsx",
                        "sheet_id": sheet_id,
                ...
                "path_c": {
                    ...
                    "selection_rule": "唯一合计级行",
                    "filters": ["flags_json.grand_total=true"],
                    "sheets": [{
                        "file_id": source_file_id,
                        "file_name": "source.xlsx",
                        "sheet_id": sheet_id,
