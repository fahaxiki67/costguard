...
> **Status: v0.1.29 preview/prerelease.** The seven-step core workflow, the macOS GUI and an
> **unsigned, ad-hoc signed macOS DMG** (Apple Silicon) and **unsigned Windows x64 packages** (per-user setup.exe + portable zip) are available. The v0.1.29
...
> [release notes](docs/RELEASE_NOTES_v0.1.29.md) and the
