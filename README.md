...
> **Status: v0.1.28 preview/prerelease.** The seven-step core workflow, the macOS GUI and an
> **unsigned, ad-hoc signed macOS DMG** (Apple Silicon) and **unsigned Windows x64 packages** (per-user setup.exe + portable zip) are available. The v0.1.28
...
> [release notes](docs/RELEASE_NOTES_v0.1.28.md) and the
