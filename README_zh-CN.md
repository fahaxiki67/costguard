...
> 当前状态：**v0.1.9 预览候选**。七步主链和 Mac 图形界面已可运行，并提供
> **未公证、ad-hoc 本地签名的 macOS DMG**（Apple Silicon 原生）。P0/P1 审核闸门、
> 全量清单分页、双值审核底稿和人工复核界面已加入；三环境 Office、性能、签名公证和真实案例
> 仍未完成，暂不标记为正式生产版。v0.1.9 在 v0.1.8 候选基础上完成了 Jiadun（价盾）改名及兼容性整理。
> 详见[发布说明](docs/RELEASE_NOTES_v0.1.9.md)和
...
Office 环境、签名公证、迁移恢复和真实案例回归仍属于 v0.1.9 发布门槛。
