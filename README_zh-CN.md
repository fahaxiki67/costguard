...
> 当前状态：**v0.1.14 预发行/预览候选**。七步主链和 Mac 图形界面已可运行，并提供
> **未公证、ad-hoc 本地签名的 macOS DMG**（Apple Silicon 原生）。本版进一步收紧
...
> 详见[发布说明](docs/RELEASE_NOTES_v0.1.14.md)和
...
Office 环境、签名公证、迁移恢复和真实案例回归仍属于 v0.1.14 发布门槛。
