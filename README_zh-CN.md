...
> 当前状态：**v0.1.10 预览候选**。七步主链和 Mac 图形界面已可运行，并提供
> **未公证、ad-hoc 本地签名的 macOS DMG**（Apple Silicon 原生）。本版增加不可变
> Run Contract、逐 Sheet 覆盖证明、四级 fail-closed 状态、差异雷达、镜像匹配、
> 受控规则和知识库、项目版本链及历史综合单价提示。四种 Office 环境、真实黄金案例、
> 现场性能、签名和公证仍未完成，暂不标记为正式生产版。
> 详见[发布说明](docs/RELEASE_NOTES_v0.1.10.md)和
...
Office 环境、签名公证、迁移恢复和真实案例回归仍属于 v0.1.10 发布门槛。
